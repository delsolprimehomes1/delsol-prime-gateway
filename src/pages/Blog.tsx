...
import { organizationSchema } from "@/utils/seo/structuredData";
...
const Blog = () => {
  ...
  const structuredData = [
    organizationSchema,
    {
      ...
      "description": "Expert insights and advice on Costa del Sol real estate market",
      "url": "https://delsolprimehomes.com/blog",
      "author": {
        "@type": "Organization",
